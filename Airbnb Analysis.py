...
st.set_page_config(page_title="AirBnb-Analysis by Mariya Stephen!!!", page_icon=":bar_chart:", layout="wide")
...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"Mariya Stephen"}')
    mail = (f'{"Mail :"}  {"Mariyastephen52@gmail.com"}')
