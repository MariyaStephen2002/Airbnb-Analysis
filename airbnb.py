...
st.set_page_config(page_title= "Airbnb Data Visualization | By Mariya Stephen",
                   
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Mariya stephen*!
...
df = pd.read_csv(r'C:\Users\stephen\Downloads\Airbnb_data.csv')
